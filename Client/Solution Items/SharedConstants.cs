...
internal class SharedConstants
{
    ...
    public const string InstallerName = "SLStudio Installer";
    ...
    public static readonly string LoggerLogFile = Path.Combine(LogsDirectory, "logs.txt");
    ...
    public static readonly bool DebugCompiled = GetDebugCompiled();
    ...
    public static readonly string StudioRepo = "https://github.com/adnan-54/SLStudio";
    ...
    public static readonly TimeSpan DefaultBackupTimeout = TimeSpan.FromSeconds(30);

    private static bool GetDebugCompiled()
    {
#if DEBUG
        return true;
#else
