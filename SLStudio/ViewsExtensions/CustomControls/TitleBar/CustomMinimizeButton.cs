...
namespace SLStudio.ViewsExtensions.CustomControls
{
    public partial class CustomMinimizeButton : UserControl, IThemedControl, IMultiLanguageControl
    {
        ...
        {
            this.toolTip.SetToolTip(this.glyph, Resources.Messages.Global.minimize);
        }
        ...
        private void OnMouseClick(object sender, MouseEventArgs e)
        {
            ...
            {
                ParentForm_.WindowState = FormWindowState.Minimized;
            }
        }
        ...
        private void OnLoad(object sender, EventArgs e)
        {
            ...
            using (Font fontTester = new Font(fontName, fontSize, GraphicsUnit.Pixel))
            {
                if (fontTester.Name == fontName)
                {
                    ...
                    glyph.Text = Char.ConvertFromUtf32(0xE921);
                }
                else
                {
